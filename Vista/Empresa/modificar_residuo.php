...
<nav class="navbar navbar-expand-lg" style="background-color: #d7ffc2;">
    ...
    <form class="col-4 p-3 m-auto" method="POST">
        ...
        <?php
        include "../../Controlador/Residuos/modificar.php";
        ...
        ?>
            ...
            <!-- Campo oculto para la empresa (se genera automaticamente) -->
            <input type="hidden" name="empresa_id" value="<?= $datos->id_empresa ?>">
