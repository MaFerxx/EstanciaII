...
require_once '../../Controlador/Recomendaciones/mostrar_recomendacion.php';
$recomendaciones = new Recomendaciones();
$recomendaciones = $recomendaciones->getRecomendacionesByEmpresa($id_empresa);
...
<div class="container mt-5">
    <h2>Recomendaciones de la Empresa</h2>
    ...
    <?php foreach ($recomendaciones as $recomendacion): ?>
        <tr>
            <td><?php echo htmlspecialchars($recomendacion['descripcion']); ?></td> 
        </tr>
    <?php endforeach; ?>
</tbody>
    ...
    <?php else: ?>
        <p>No hay recomendaciones disponibles para esta empresa.</p>
    <?php endif; ?>
</div>
