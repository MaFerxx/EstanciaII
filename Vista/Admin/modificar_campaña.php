...
<nav class="navbar navbar-expand-lg" style="background-color: #61c9a8;">
    <div class="container-fluid">
        <a href="campañas.php" class="btn btn-outline-primary">Regresar</a>
...
<form class="col-4 p-3 m-auto" action="../../Controlador/Campañas/modificar_campañas.php" method="POST">
