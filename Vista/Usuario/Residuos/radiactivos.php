<?php
session_start();
require_once "../../../Controlador/Residuos/radiactivos.php";
...
<body>
    ...
    <h2 class="text-center">Lista de Residuos Radiactivos</h2>
    <table class="table table-bordered">
        ...
        <tbody>
            <?php foreach ($residuosRadiactivos as $residuo): ?>
                <tr>
