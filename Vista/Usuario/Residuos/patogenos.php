<?php
session_start();
require_once "../../../Controlador/Residuos/patogenos.php";
...
<body>
    ...
    <h2 class="text-center">Lista de Residuos Infecciosos o Patógenos</h2>
    <table class="table table-bordered">
        ...
        <tbody>
            <?php foreach ($residuosPatogenos as $residuo): ?>
                <tr>
