<?php
session_start();
require_once "../../../Controlador/Residuos/corrosivos.php";
...
<body>
    ...
    <h2 class="text-center">Lista de Residuos Corrosivos</h2>
    <table class="table table-bordered">
        ...
        <tbody>
            <?php foreach ($residuosCorrosivos as $residuo): ?>
                <tr>
...
<!-- Contacto -->
<footer id="quienes-somos" class="text-center py-2" style="background: linear-gradient(to bottom right, #a8e6cf, #dcedc1); color: #333; position: fixed; bottom: 0; width: 100%; font-size: 0.9em;">
    <div class="container">
        <h4>EcoFusionMap</h4>
        <h5>Contáctanos</h5>
        <p>
